...
export const indiaGeography: IndiaGeography[] = [
    { name: 'Andaman and Nicobar Islands', districts: [{ name: 'Nicobar', talukas: [{ name: 'Car Nicobar', villages: ['Malacca', 'Kakana'] }] }, { name: 'North and Middle Andaman', talukas: [{ name: 'Diglipur', villages: ['Diglipur', 'Kalighat'] }] }, { name: 'South Andaman', talukas: [{ name: 'Port Blair', villages: ['Port Blair', 'Garacharma'] }] }] },
    { name: 'Andhra Pradesh', districts: [{ name: 'Anantapur', talukas: [{ name: 'Anantapur', villages: ['Kamarupalli', 'Somanadoddi'] }] }, { name: 'Chittoor', talukas: [{ name: 'Chittoor', villages: ['Murakambattu', 'Diguva Thotavuru'] }] }, { name: 'East Godavari', talukas: [{ name: 'Rajahmundry', villages: ['Kateru', 'Hukumpeta'] }] }, { name: 'Guntur', talukas: [{ name: 'Guntur', villages: ['Ankireddypalem', 'Gorantla'] }] }, { name: 'Krishna', talukas: [{ name: 'Vijayawada', villages: ['Gannavaram', 'Nunna'] }] }, { name: 'Kurnool', talukas: [{ name: 'Kurnool', villages: ['Panchalingala', 'Nidur'] }] }, { name: 'Prakasam', talukas: [{ name: 'Ongole', villages: ['Kothapatnam', 'Throvagunta'] }] }, { name: 'Srikakulam', talukas: [{ name: 'Srikakulam', villages: ['Arasavalli', 'Balaga'] }] }, { name: 'Sri Potti Sriramulu Nellore', talukas: [{ name: 'Nellore', villages: ['Akkacheruvu Padu', 'Devarapalem'] }] }, { name: 'Visakhapatnam', talukas: [{ name: 'Visakhapatnam', villages: ['Gopalapatnam', 'Madhurawada'] }] }, { name: 'Vizianagaram', talukas: [{ name: 'Vizianagaram', villages: ['Gajularega', 'Kanapaka'] }] }, { name: 'West Godavari', talukas: [{ name: 'Eluru', villages: ['Chataparru', 'Jalipudi'] }] }, { name: 'Y.S.R. Kadapa', talukas: [{ name: 'Kadapa', villages: ['Chinthalapalem', 'Patha Kadapa'] }] }] },
    { name: 'Arunachal Pradesh', districts: [{ name: 'Tawang', talukas: [{ name: 'Tawang', villages: ['Lhou', 'Kyaleng'] }] }, { name: 'West Kameng', talukas: [{ name: 'Bomdila', villages: ['Salari', 'Sera'] }] }, { name: 'East Kameng', talukas: [{ name: 'Seppa', villages: ['Pabua', 'Sawa'] }] }, { name: 'Papum Pare', talukas: [{ name: 'Itanagar', villages: ['Naharlagun', 'Nirjuli'] }] }, { name: 'Upper Subansiri', talukas: [{ name: 'Daporijo', villages: ['Don', 'Giba'] }] }, { name: 'West Siang', talukas: [{ name: 'Aalo', villages: ['Kabu', 'Doke'] }] }, { name: 'East Siang', talukas: [{ name: 'Pasighat', villages: ['Ledum', 'Renging'] }] }, { name: 'Upper Siang', talukas: [{ name: 'Yingkiong', villages: ['Karko', 'Palling'] }] }, { name: 'Changlang', talukas: [{ name: 'Changlang', villages: ['Kangkho', 'Laktong'] }] }, { name: 'Tirap', talukas: [{ name: 'Khonsa', villages: ['Laju', 'Dadam'] }] }, { name: 'Lohit', talukas: [{ name: 'Tezu', villages: ['Tindolong', 'Tafrogam'] }] }] },
    { name: 'Assam', districts: [{ name: 'Baksa', talukas: [{ name: 'Mushalpur', villages: ['Barimukh', 'Simla'] }] }, { name: 'Barpeta', talukas: [{ name: 'Barpeta', villages: ['Niz-Barpeta', 'Howly'] }] }, { name: 'Biswanath', talukas: [{ name: 'Biswanath Chariali', villages: ['Behali', 'Gohpur'] }] }, { name: 'Bongaigaon', talukas: [{ name: 'Bongaigaon', villages: ['Abhayapuri', 'Boitamari'] }] }, { name: 'Cachar', talukas: [{ name: 'Silchar', villages: ['Lakhipur', 'Sonai'] }] }, { name: 'Charaideo', talukas: [{ name: 'Sonari', villages: ['Sapekhati', 'Mahmora'] }] }, { name: 'Chirang', talukas: [{ name: 'Kajalgaon', villages: ['Sidli', 'Bijni'] }] }, { name: 'Darrang', talukas: [{ name: 'Mangaldoi', villages: ['Sipajhar', 'Dalgaon'] }] }, { name: 'Dhemaji', talukas: [{ name: 'Dhemaji', villages: ['Sissiborgaon', 'Jonai'] }] }, { name: 'Dhubri', talukas: [{ name: 'Dhubri', villages: ['Gauripur', 'Bilasipara'] }] }, { name: 'Dibrugarh', talukas: [{ name: 'Dibrugarh', villages: ['Tingkhong', 'Naharkatia'] }] }, { name: 'Dima Hasao', talukas: [{ name: 'Haflong', villages: ['Mahur', 'Maibang'] }] }, { name: 'Goalpara', talukas: [{ name: 'Goalpara', villages: ['Lakhipur', 'Dudhnai'] }] }, { name: 'Golaghat', talukas: [{ name: 'Golaghat', villages: ['Sarupathar', 'Dergaon'] }] }, { name: 'Hailakandi', talukas: [{ name: 'Hailakandi', villages: ['Lala', 'Katlicherra'] }] }, { name: 'Hojai', talukas: [{ name: 'Hojai', villages: ['Lanka', 'Lumding'] }] }, { name: 'Jorhat', talukas: [{ name: 'Jorhat', villages: ['Titabar', 'Mariani'] }] }, { name: 'Kamrup', talukas: [{ name: 'Amingaon', villages: ['Hajo', 'Rangia'] }] }, { name: 'Kamrup Metropolitan', talukas: [{ name: 'Guwahati', villages: ['Dispur', 'Sonapur'] }] }, { name: 'Karbi Anglong', talukas: [{ name: 'Diphu', villages: ['Donka', 'Phuloni'] }] }, { name: 'Karimganj', talukas: [{ name: 'Karimganj', villages: ['Badarpur', 'Patharkandi'] }] }, { name: 'Kokrajhar', talukas: [{ name: 'Kokrajhar', villages: ['Gossaigaon', 'Dotma'] }] }, { name: 'Lakhimpur', talukas: [{ name: 'North Lakhimpur', villages: ['Bihpuria', 'Dhakuakhana'] }] }, { name: 'Majuli', talukas: [{ name: 'Garamur', villages: ['Kamalabari', 'Phulani'] }] }, { name: 'Morigaon', talukas: [{ name: 'Morigaon', villages: ['Laharighat', 'Mikirbheta'] }] }, { name: 'Nagaon', talukas: [{ name: 'Nagaon', villages: ['Rupahi', 'Dhing'] }] }, { name: 'Nalbari', talukas: [{ name: 'Nalbari', villages: ['Tihu', 'Barkhetri'] }] }, { name: 'Sivasagar', talukas: [{ name: 'Sivasagar', villages: ['Demow', 'Amguri'] }] }, { name: 'Sonitpur', talukas: [{ name: 'Tezpur', villages: ['Rangapara', 'Dhekiajuli'] }] }, { name: 'South Salmara-Mankachar', talukas: [{ name: 'Hatsingimari', villages: ['Mankachar', 'South Salmara'] }] }, { name: 'Tinsukia', talukas: [{ name: 'Tinsukia', villages: ['Digboi', 'Margherita'] }] }, { name: 'Udalguri', talukas: [{ name: 'Udalguri', villages: ['Tangla', 'Harisinga'] }] }, { name: 'West Karbi Anglong', talukas: [{ name: 'Hamren', villages: ['Bokajan', 'Howraghat'] }] }] },
    { name: 'Bihar', districts: [{ name: 'Araria', talukas: [{ name: 'Araria', villages: ['Forbesganj', 'Jokihat'] }] }, { name: 'Arwal', talukas: [{ name: 'Arwal', villages: ['Kurtha', 'Kaler'] }] }, { name: 'Aurangabad', talukas: [{ name: 'Aurangabad', villages: ['Daudnagar', 'Goh'] }] }, { name: 'Banka', talukas: [{ name: 'Banka', villages: ['Amarpur', 'Katoria'] }] }, { name: 'Begusarai', talukas: [{ name: 'Begusarai', villages: ['Barauni', 'Teghra'] }] }, { name: 'Bhagalpur', talukas: [{ name: 'Bhagalpur', villages: ['Kahalgaon', 'Nathnagar'] }] }, { name: 'Bhojpur', talukas: [{ name: 'Arrah', villages: ['Jagdispur', 'Piro'] }] }, { name: 'Buxar', talukas: [{ name: 'Buxar', villages: ['Dumraon', 'Itarhi'] }] }, { name: 'Darbhanga', talukas: [{ name: 'Darbhanga', villages: ['Benipur', 'Singhwara'] }] }, { name: 'East Champaran', talukas: [{ name: 'Motihari', villages: ['Raxaul', 'Chakia'] }] }, { name: 'Gaya', talukas: [{ name: 'Gaya', villages: ['Bodh Gaya', 'Sherghati'] }] }, { name: 'Gopalganj', talukas: [{ name: 'Gopalganj', villages: ['Hathua', 'Mirganj'] }] }, { name: 'Jamui', talukas: [{ name: 'Jamui', villages: ['Jhajha', 'Sikandra'] }] }, { name: 'Jehanabad', talukas: [{ name: 'Jehanabad', villages: ['Makhdumpur', 'Ghoshi'] }] }, { name: 'Kaimur', talukas: [{ name: 'Bhabua', villages: ['Mohania', 'Kudra'] }] }, { name: 'Katihar', talukas: [{ name: 'Katihar', villages: ['Barsoi', 'Manihari'] }] }, { name: 'Khagaria', talukas: [{ name: 'Khagaria', villages: ['Gogri', 'Parbatta'] }] }, { name: 'Kishanganj', talukas: [{ name: 'Kishanganj', villages: ['Bahadurganj', 'Thakurganj'] }] }, { name: 'Lakhisarai', talukas: [{ name: 'Lakhisarai', villages: ['Barahiya', 'Suryagarha'] }] }, { name: 'Madhepura', talukas: [{ name: 'Madhepura', villages: ['Murliganj', 'Singheshwar'] }] }, { name: 'Madhubani', talukas: [{ name: 'Madhubani', villages: ['Jainagar', 'Jhanjharpur'] }] }, { name: 'Munger', talukas: [{ name: 'Munger', villages: ['Jamalpur', 'Kharagpur'] }] }, { name: 'Muzaffarpur', talukas: [{ name: 'Muzaffarpur', villages: ['Kanti', 'Motipur'] }] }, { name: 'Nalanda', talukas: [{ name: 'Bihar Sharif', villages: ['Rajgir', 'Hilsa'] }] }, { name: 'Nawada', talukas: [{ name: 'Nawada', villages: ['Hisua', 'Warisaliganj'] }] }, { name: 'Patna', talukas: [{ name: 'Patna', villages: ['Danapur', 'Bakhtiarpur'] }] }, { name: 'Purnia', talukas: [{ name: 'Purnia', villages: ['Banmankhi', 'Kasba'] }] }, { name: 'Rohtas', talukas: [{ name: 'Sasaram', villages: ['Dehri', 'Nokha'] }] }, { name: 'Saharsa', talukas: [{ name: 'Saharsa', villages: ['Simri Bakhtiarpur', 'Sonbarsa'] }] }, { name: 'Samastipur', talukas: [{ name: 'Samastipur', villages: ['Dalsinghsarai', 'Rosera'] }] }, { name: 'Saran', talukas: [{ name: 'Chhapra', villages: ['Sonepur', 'Marhaura'] }] }, { name: 'Sheikhpura', talukas: [{ name: 'Sheikhpura', villages: ['Barbigha', 'Ariari'] }] }, { name: 'Sheohar', talukas: [{ name: 'Sheohar', villages: ['Tariani', 'Piprahi'] }] }, { name: 'Sitamarhi', talukas: [{ name: 'Sitamarhi', villages: ['Bairgania', 'Pupri'] }] }, { name: 'Siwan', talukas: [{ name: 'Siwan', villages: ['Maharajganj', 'Mairwa'] }] }, { name: 'Supaul', talukas: [{ name: 'Supaul', villages: ['Birpur', 'Nirmali'] }] }, { name: 'Vaishali', talukas: [{ name: 'Hajipur', villages: ['Lalganj', 'Mahnar'] }] }, { name: 'West Champaran', talukas: [{ name: 'Bettiah', villages: ['Narkatiaganj', 'Bagaha'] }] }] },
    { name: 'Chandigarh', districts: [{ name: 'Chandigarh', talukas: [{ name: 'Chandigarh', villages: ['Dhanas', 'Kajheri'] }] }] },
    { name: 'Chhattisgarh', districts: [{ name: 'Balod', talukas: [{ name: 'Balod', villages: ['Dondi Lohara', 'Gunderdehi'] }] }, { name: 'Baloda Bazar', talukas: [{ name: 'Baloda Bazar', villages: ['Bhatapara', 'Kasdol'] }] }, { name: 'Balrampur', talukas: [{ name: 'Balrampur', villages: ['Ramanujganj', 'Wadrafnagar'] }] }, { name: 'Bastar', talukas: [{ name: 'Jagdalpur', villages: ['Bastar', 'Lohandiguda'] }] }, { name: 'Bemetara', talukas: [{ name: 'Bemetara', villages: ['Saja', 'Nawagarh'] }] }, { name: 'Bijapur', talukas: [{ name: 'Bijapur', villages: ['Bhairamgarh', 'Usur'] }] }, { name: 'Bilaspur', talukas: [{ name: 'Bilaspur', villages: ['Kota', 'Takhatpur'] }] }, { name: 'Dantewada', talukas: [{ name: 'Dantewada', villages: ['Gidam', 'Kuakonda'] }] }, { name: 'Dhamtari', talukas: [{ name: 'Dhamtari', villages: ['Kurud', 'Nagri'] }] }, { name: 'Durg', talukas: [{ name: 'Durg', villages: ['Patan', 'Dhamdha'] }] }, { name: 'Gariaband', talukas: [{ name: 'Gariaband', villages: ['Mainpur', 'Chhura'] }] }, { name: 'Janjgir-Champa', talukas: [{ name: 'Janjgir', villages: ['Champa', 'Sakti'] }] }, { name: 'Jashpur', talukas: [{ name: 'Jashpur', villages: ['Kunkuri', 'Pathalgaon'] }] }, { name: 'Kanker', talukas: [{ name: 'Kanker', villages: ['Bhanupratappur', 'Charama'] }] }, { name: 'Kondagaon', talukas: [{ name: 'Kondagaon', villages: ['Keskal', 'Pharasgaon'] }] }, { name: 'Korba', talukas: [{ name: 'Korba', villages: ['Katghora', 'Pali'] }] }, { name: 'Koriya', talukas: [{ name: 'Baikunthpur', villages: ['Manendragarh', 'Sonhat'] }] }, { name: 'Mahasamund', talukas: [{ name: 'Mahasamund', villages: ['Saraipali', 'Basna'] }] }, { name: 'Mungeli', talukas: [{ name: 'Mungeli', villages: ['Lormi', 'Patharia'] }] }, { name: 'Narayanpur', talukas: [{ name: 'Narayanpur', villages: ['Orchha', ''] }] }, { name: 'Raigarh', talukas: [{ name: 'Raigarh', villages: ['Sarangarh', 'Kharsia'] }] }, { name: 'Raipur', talukas: [{ name: 'Raipur', villages: ['Arang', 'Tilda'] }] }, { name: 'Rajnandgaon', talukas: [{ name: 'Rajnandgaon', villages: ['Dongargarh', 'Khairagarh'] }] }, { name: 'Sukma', talukas: [{ name: 'Sukma', villages: ['Konta', 'Chhindgarh'] }] }, { name: 'Surajpur', talukas: [{ name: 'Surajpur', villages: ['Pratappur', 'Bhaiyathan'] }] }, { name: 'Surguja', talukas: [{ name: 'Ambikapur', villages: ['Lundra', 'Sitapur'] }] }] },
    { name: 'Dadra and Nagar Haveli and Daman and Diu', districts: [{ name: 'Daman', talukas: [{ name: 'Daman', villages: ['Moti Daman', 'Nani Daman'] }] }, { name: 'Diu', talukas: [{ name: 'Diu', villages: ['Ghoghla', 'Fudam'] }] }, { name: 'Dadra and Nagar Haveli', talukas: [{ name: 'Silvassa', villages: ['Amli', 'Dadra'] }] }] },
    { name: 'Delhi', districts: [{ name: 'Central Delhi', talukas: [{ name: 'Daryaganj', villages: ['Chandni Chowk', 'Karol Bagh'] }] }, { name: 'East Delhi', talukas: [{ name: 'Preet Vihar', villages: ['Mayur Vihar', 'Gandhi Nagar'] }] }, { name: 'New Delhi', talukas: [{ name: 'Connaught Place', villages: ['Chanakyapuri', 'Vasant Vihar'] }] }, { name: 'North Delhi', talukas: [{ name: 'Model Town', villages: ['Narela', 'Alipur'] }] }, { name: 'North East Delhi', talukas: [{ name: 'Seelampur', villages: ['Shahdara', 'Yamuna Vihar'] }] }, { name: 'North West Delhi', talukas: [{ name: 'Kanjhawala', villages: ['Rohini', 'Saraswati Vihar'] }] }, { name: 'Shahdara', talukas: [{ name: 'Shahdara', villages: ['Vivek Vihar', 'Seemapuri'] }] }, { name: 'South Delhi', talukas: [{ name: 'Saket', villages: ['Hauz Khas', 'Mehrauli'] }] }, { name: 'South East Delhi', talukas: [{ name: 'Defence Colony', villages: ['Kalkaji', 'Sarita Vihar'] }] }, { name: 'South West Delhi', talukas: [{ name: 'Dwarka', villages: ['Najafgarh', 'Kapashera'] }] }, { name: 'West Delhi', talukas: [{ name: 'Rajouri Garden', villages: ['Patel Nagar', 'Punjabi Bagh'] }] }] },
    { name: 'Goa', districts: [{ name: 'North Goa', talukas: [{ name: 'Panaji', villages: ['Taleigao', 'Santa Cruz'] }, { name: 'Mapusa', villages: ['Aldona', 'Siolim'] }] }, { name: 'South Goa', talukas: [{ name: 'Margao', villages: ['Cuncolim', 'Navelim'] }, { name: 'Vasco da Gama', villages: ['Mormugao', 'Cortalim'] }] }] },
    { name: 'Gujarat', districts: [{ name: 'Ahmedabad', talukas: [{ name: 'Ahmedabad', villages: ['Daskroi', 'Sanand'] }] }, { name: 'Amreli', talukas: [{ name: 'Amreli', villages: ['Babra', 'Lathi'] }] }, { name: 'Anand', talukas: [{ name: 'Anand', villages: ['Borsad', 'Petlad'] }] }, { name: 'Aravalli', talukas: [{ name: 'Modasa', villages: ['Bayad', 'Dhansura'] }] }, { name: 'Banaskantha', talukas: [{ name: 'Palanpur', villages: ['Deesa', 'Dhanera'] }] }, { name: 'Bharuch', talukas: [{ name: 'Bharuch', villages: ['Ankleshwar', 'Jambusar'] }] }, { name: 'Bhavnagar', talukas: [{ name: 'Bhavnagar', villages: ['Ghogha', 'Sihor'] }] }, { name: 'Botad', talukas: [{ name: 'Botad', villages: ['Gadhada', 'Barwala'] }] }, { name: 'Chhota Udaipur', talukas: [{ name: 'Chhota Udaipur', villages: ['Bodeli', 'Kavant'] }] }, { name: 'Dahod', talukas: [{ name: 'Dahod', villages: ['Jhalod', 'Limkheda'] }] }, { name: 'Dang', talukas: [{ name: 'Ahwa', villages: ['Waghai', 'Saputara'] }] }, { name: 'Devbhoomi Dwarka', talukas: [{ name: 'Khambhalia', villages: ['Dwarka', 'Okhamandal'] }] }, { name: 'Gandhinagar', talukas: [{ name: 'Gandhinagar', villages: ['Kalol', 'Mansa'] }] }, { name: 'Gir Somnath', talukas: [{ name: 'Veraval', villages: ['Una', 'Talala'] }] }, { name: 'Jamnagar', talukas: [{ name: 'Jamnagar', villages: ['Jodiya', 'Kalavad'] }] }, { name: 'Junagadh', talukas: [{ name: 'Junagadh', villages: ['Manavadar', 'Visavadar'] }] }, { name: 'Kheda', talukas: [{ name: 'Nadiad', villages: ['Kheda', 'Kapadvanj'] }] }, { name: 'Kutch', talukas: [{ name: 'Bhuj', villages: ['Anjar', 'Mandvi'] }] }, { name: 'Mahisagar', talukas: [{ name: 'Lunawada', villages: ['Balasinor', 'Kadana'] }] }, { name: 'Mehsana', talukas: [{ name: 'Mehsana', villages: ['Kadi', 'Visnagar'] }] }, { name: 'Morbi', talukas: [{ name: 'Morbi', villages: ['Wankaner', 'Tankara'] }] }, { name: 'Narmada', talukas: [{ name: 'Rajpipla', villages: ['Nandod', 'Sagbara'] }] }, { name: 'Navsari', talukas: [{ name: 'Navsari', villages: ['Jalalpore', 'Gandevi'] }] }, { name: 'Panchmahal', talukas: [{ name: 'Godhra', villages: ['Halol', 'Kalol'] }] }, { name: 'Patan', talukas: [{ name: 'Patan', villages: ['Sidhpur', 'Chanasma'] }] }, { name: 'Porbandar', talukas: [{ name: 'Porbandar', villages: ['Ranavav', 'Kutiyana'] }] }, { name: 'Rajkot', talukas: [{ name: 'Rajkot', villages: ['Gondal', 'Jetpur'] }] }, { name: 'Sabarkantha', talukas: [{ name: 'Himatnagar', villages: ['Idar', 'Prantij'] }] }, { name: 'Surat', talukas: [{ name: 'Surat', villages: ['Choryasi', 'Olpad'] }] }, { name: 'Surendranagar', talukas: [{ name: 'Surendranagar', villages: ['Wadhwan', 'Limbdi'] }] }, { name: 'Tapi', talukas: [{ name: 'Vyara', villages: ['Songadh', 'Valod'] }] }, { name: 'Vadodara', talukas: [{ name: 'Vadodara', villages: ['Padra', 'Savli'] }] }, { name: 'Valsad', talukas: [{ name: 'Valsad', villages: ['Pardi', 'Vapi'] }] }] },
    { name: 'Haryana', districts: [{ name: 'Ambala', talukas: [{ name: 'Ambala', villages: ['Barara', 'Naraingarh'] }] }, { name: 'Bhiwani', talukas: [{ name: 'Bhiwani', villages: ['Loharu', 'Tosham'] }] }, { name: 'Charkhi Dadri', talukas: [{ name: 'Charkhi Dadri', villages: ['Badhra', 'Dadri'] }] }, { name: 'Faridabad', talukas: [{ name: 'Faridabad', villages: ['Ballabhgarh', ''] }] }, { name: 'Fatehabad', talukas: [{ name: 'Fatehabad', villages: ['Ratia', 'Tohana'] }] }, { name: 'Gurugram', talukas: [{ name: 'Gurugram', villages: ['Pataudi', 'Sohna'] }] }, { name: 'Hisar', talukas: [{ name: 'Hisar', villages: ['Hansi', 'Adampur'] }] }, { name: 'Jhajjar', talukas: [{ name: 'Jhajjar', villages: ['Bahadurgarh', 'Beri'] }] }, { name: 'Jind', talukas: [{ name: 'Jind', villages: ['Narwana', 'Safidon'] }] }, { name: 'Kaithal', talukas: [{ name: 'Kaithal', villages: ['Guhla', 'Kalayat'] }] }, { name: 'Karnal', talukas: [{ name: 'Karnal', villages: ['Assandh', 'Indri'] }] }, { name: 'Kurukshetra', talukas: [{ name: 'Thanesar', villages: ['Pehowa', 'Shahbad'] }] }, { name: 'Mahendragarh', talukas: [{ name: 'Narnaul', villages: ['Mahendragarh', 'Ateli'] }] }, { name: 'Nuh', talukas: [{ name: 'Nuh', villages: ['Ferozepur Jhirka', 'Taoru'] }] }, { name: 'Palwal', talukas: [{ name: 'Palwal', villages: ['Hodal', 'Hathin'] }] }, { name: 'Panchkula', talukas: [{ name: 'Panchkula', villages: ['Kalka', 'Raipur Rani'] }] }, { name: 'Panipat', talukas: [{ name: 'Panipat', villages: ['Samalkha', 'Israna'] }] }, { name: 'Rewari', talukas: [{ name: 'Rewari', villages: ['Bawal', 'Kosli'] }] }, { name: 'Rohtak', talukas: [{ name: 'Rohtak', villages: ['Meham', 'Sampla'] }] }, { name: 'Sirsa', talukas: [{ name: 'Sirsa', villages: ['Ellenabad', 'Dabwali'] }] }, { name: 'Sonipat', talukas: [{ name: 'Sonipat', villages: ['Gohana', 'Kharkhoda'] }] }, { name: 'Yamunanagar', talukas: [{ name: 'Jagadhri', villages: ['Bilaspur', 'Radaur'] }] }] },
    { name: 'Himachal Pradesh', districts: [{ name: 'Bilaspur', talukas: [{ name: 'Bilaspur', villages: ['Ghumarwin', 'Jhandutta'] }] }, { name: 'Chamba', talukas: [{ name: 'Chamba', villages: ['Dalhousie', 'Bhattiyat'] }] }, { name: 'Hamirpur', talukas: [{ name: 'Hamirpur', villages: ['Barsar', 'Nadaun'] }] }, { name: 'Kangra', talukas: [{ name: 'Dharamshala', villages: ['Palampur', 'Kangra'] }] }, { name: 'Kinnaur', talukas: [{ name: 'Reckong Peo', villages: ['Kalpa', 'Pooh'] }] }, { name: 'Kullu', talukas: [{ name: 'Kullu', villages: ['Manali', 'Banjar'] }] }, { name: 'Lahaul and Spiti', talukas: [{ name: 'Keylong', villages: ['Udaipur', 'Spiti'] }] }, { name: 'Mandi', talukas: [{ name: 'Mandi', villages: ['Sundernagar', 'Jogindernagar'] }] }, { name: 'Shimla', talukas: [{ name: 'Shimla', villages: ['Rohru', 'Rampur'] }] }, { name: 'Sirmaur', talukas: [{ name: 'Nahan', villages: ['Paonta Sahib', 'Rajgarh'] }] }, { name: 'Solan', talukas: [{ name: 'Solan', villages: ['Nalagarh', 'Arki'] }] }, { name: 'Una', talukas: [{ name: 'Una', villages: ['Amb', 'Haroli'] }] }] },
    { name: 'Jammu and Kashmir', districts: [{ name: 'Anantnag', talukas: [{ name: 'Anantnag', villages: ['Pahalgam', 'Bijbehara'] }] }, { name: 'Bandipora', talukas: [{ name: 'Bandipora', villages: ['Sumbal', 'Gurez'] }] }, { name: 'Baramulla', talukas: [{ name: 'Baramulla', villages: ['Sopore', 'Gulmarg'] }] }, { name: 'Budgam', talukas: [{ name: 'Budgam', villages: ['Chadoora', 'Beerwah'] }] }, { name: 'Doda', talukas: [{ name: 'Doda', villages: ['Bhaderwah', 'Thathri'] }] }, { name: 'Ganderbal', talukas: [{ name: 'Ganderbal', villages: ['Kangan', 'Lar'] }] }, { name: 'Jammu', talukas: [{ name: 'Jammu', villages: ['R.S. Pura', 'Akhnoor'] }] }, { name: 'Kathua', talukas: [{ name: 'Kathua', villages: ['Basohli', 'Billawar'] }] }, { name: 'Kishtwar', talukas: [{ name: 'Kishtwar', villages: ['Paddar', 'Marwah'] }] }, { name: 'Kulgam', talukas: [{ name: 'Kulgam', villages: ['Damhal Hanjipora', 'Devsar'] }] }, { name: 'Kupwara', talukas: [{ name: 'Kupwara', villages: ['Handwara', 'Karnah'] }] }, { name: 'Poonch', talukas: [{ name: 'Poonch', villages: ['Mendhar', 'Surankote'] }] }, { name: 'Pulwama', talukas: [{ name: 'Pulwama', villages: ['Tral', 'Awantipora'] }] }, { name: 'Rajouri', talukas: [{ name: 'Rajouri', villages: ['Nowshera', 'Sunderbani'] }] }, { name: 'Ramban', talukas: [{ name: 'Ramban', villages: ['Banihal', 'Gool'] }] }, { name: 'Reasi', talukas: [{ name: 'Reasi', villages: ['Katra', 'Mahore'] }] }, { name: 'Samba', talukas: [{ name: 'Samba', villages: ['Vijaypur', 'Ghagwal'] }] }, { name: 'Shopian', talukas: [{ name: 'Shopian', villages: ['Zainapora', 'Keller'] }] }, { name: 'Srinagar', talukas: [{ name: 'Srinagar', villages: ['Hazratbal', 'Pantha Chowk'] }] }, { name: 'Udhampur', talukas: [{ name: 'Udhampur', villages: ['Chenani', 'Ramnagar'] }] }] },
    { name: 'Jharkhand', districts: [{ name: 'Bokaro', talukas: [{ name: 'Bokaro Steel City', villages: ['Chas', 'Bermo'] }] }, { name: 'Chatra', talukas: [{ name: 'Chatra', villages: ['Itkhori', 'Simaria'] }] }, { name: 'Deoghar', talukas: [{ name: 'Deoghar', villages: ['Madhupur', 'Sarath'] }] }, { name: 'Dhanbad', talukas: [{ name: 'Dhanbad', villages: ['Jharia', 'Tundi'] }] }, { name: 'Dumka', talukas: [{ name: 'Dumka', villages: ['Jamtara', 'Saraiyahat'] }] }, { name: 'East Singhbhum', talukas: [{ name: 'Jamshedpur', villages: ['Ghatshila', 'Potka'] }] }, { name: 'Garhwa', talukas: [{ name: 'Garhwa', villages: ['Ranka', 'Bhandaria'] }] }, { name: 'Giridih', talukas: [{ name: 'Giridih', villages: ['Dumri', 'Bagodar'] }] }, { name: 'Godda', talukas: [{ name: 'Godda', villages: ['Mahagama', 'Pathargama'] }] }, { name: 'Gumla', talukas: [{ name: 'Gumla', villages: ['Simdega', 'Kolebira'] }] }, { name: 'Hazaribagh', talukas: [{ name: 'Hazaribagh', villages: ['Barhi', 'Ichak'] }] }, { name: 'Jamtara', talukas: [{ name: 'Jamtara', villages: ['Nala', 'Kundahit'] }] }, { name: 'Khunti', talukas: [{ name: 'Khunti', villages: ['Torpa', 'Karra'] }] }, { name: 'Koderma', talukas: [{ name: 'Koderma', villages: ['Jainagar', 'Satgawan'] }] }, { name: 'Latehar', talukas: [{ name: 'Latehar', villages: ['Chandwa', 'Balumath'] }] }, { name: 'Lohardaga', talukas: [{ name: 'Lohardaga', villages: ['Kisko', 'Peshrar'] }] }, { name: 'Pakur', talukas: [{ name: 'Pakur', villages: ['Maheshpur', 'Amrapara'] }] }, { name: 'Palamu', talukas: [{ name: 'Daltonganj', villages: ['Hussainabad', 'Chainpur'] }] }, { name: 'Ramgarh', talukas: [{ name: 'Ramgarh', villages: ['Patratu', 'Mandu'] }] }, { name: 'Ranchi', talukas: [{ name: 'Ranchi', villages: ['Kanke', 'Ormanjhi'] }] }, { name: 'Sahibganj', talukas: [{ name: 'Sahibganj', villages: ['Rajmahal', 'Barharwa'] }] }, { name: 'Seraikela Kharsawan', talukas: [{ name: 'Seraikela', villages: ['Chandil', 'Gamharia'] }] }, { name: 'Simdega', talukas: [{ name: 'Simdega', villages: ['Kolebira', 'Bano'] }] }, { name: 'West Singhbhum', talukas: [{ name: 'Chaibasa', villages: ['Jagannathpur', 'Noamundi'] }] }] },
    { name: 'Karnataka', districts: [{ name: 'Bagalkot', talukas: [{ name: 'Bagalkot', villages: ['Jamkhandi', 'Mudhol'] }] }, { name: 'Ballari', talukas: [{ name: 'Ballari', villages: ['Hospet', 'Siruguppa'] }] }, { name: 'Belagavi', talukas: [{ name: 'Belagavi', villages: ['Gokak', 'Chikkodi'] }] }, { name: 'Bengaluru Rural', talukas: [{ name: 'Devanahalli', villages: ['Doddaballapur', 'Nelamangala'] }] }, { name: 'Bengaluru Urban', talukas: [{ name: 'Bengaluru', villages: ['Anekal', ''] }] }, { name: 'Bidar', talukas: [{ name: 'Bidar', villages: ['Basavakalyan', 'Humnabad'] }] }, { name: 'Chamarajanagar', talukas: [{ name: 'Chamarajanagar', villages: ['Kollegal', 'Gundlupet'] }] }, { name: 'Chikkaballapur', talukas: [{ name: 'Chikkaballapur', villages: ['Gauribidanur', 'Sidlaghatta'] }] }, { name: 'Chikkamagaluru', talukas: [{ name: 'Chikkamagaluru', villages: ['Kadur', 'Tarikere'] }] }, { name: 'Chitradurga', talukas: [{ name: 'Chitradurga', villages: ['Hiriyur', 'Molakalmuru'] }] }, { name: 'Dakshina Kannada', talukas: [{ name: 'Mangaluru', villages: ['Bantwal', 'Puttur'] }] }, { name: 'Davanagere', talukas: [{ name: 'Davanagere', villages: ['Harihar', 'Jagalur'] }] }, { name: 'Dharwad', talukas: [{ name: 'Dharwad', villages: ['Hubballi', 'Kalghatgi'] }] }, { name: 'Gadag', talukas: [{ name: 'Gadag', villages: ['Ron', 'Nargund'] }] }, { name: 'Hassan', talukas: [{ name: 'Hassan', villages: ['Arsikere', 'Channarayapatna'] }] }, { name: 'Haveri', talukas: [{ name: 'Haveri', villages: ['Ranibennur', 'Byadgi'] }] }, { name: 'Kalaburagi', talukas: [{ name: 'Kalaburagi', villages: ['Aland', 'Chincholi'] }] }, { name: 'Kodagu', talukas: [{ name: 'Madikeri', villages: ['Somwarpet', 'Virajpet'] }] }, { name: 'Kolar', talukas: [{ name: 'Kolar', villages: ['Malur', 'Bangarapet'] }] }, { name: 'Koppal', talukas: [{ name: 'Koppal', villages: ['Gangavati', 'Yelbarga'] }] }, { name: 'Mandya', talukas: [{ name: 'Mandya', villages: ['Maddur', 'Malavalli'] }] }, { name: 'Mysuru', talukas: [{ name: 'Mysuru', villages: ['Hunsur', 'Nanjangud'] }] }, { name: 'Raichur', talukas: [{ name: 'Raichur', villages: ['Manvi', 'Sindhanur'] }] }, { name: 'Ramanagara', talukas: [{ name: 'Ramanagara', villages: ['Channapatna', 'Kanakapura'] }] }, { name: 'Shivamogga', talukas: [{ name: 'Shivamogga', villages: ['Bhadravati', 'Sagar'] }] }, { name: 'Tumakuru', talukas: [{ name: 'Tumakuru', villages: ['Tiptur', 'Sira'] }] }, { name: 'Udupi', talukas: [{ name: 'Udupi', villages: ['Kundapura', 'Karkala'] }] }, { name: 'Uttara Kannada', talukas: [{ name: 'Karwar', villages: ['Sirsi', 'Honnavar'] }] }, { name: 'Vijayapura', talukas: [{ name: 'Vijayapura', villages: ['Indi', 'Basavana Bagevadi'] }] }, { name: 'Yadgir', talukas: [{ name: 'Yadgir', villages: ['Shahapur', 'Surpur'] }] }] },
    { name: 'Kerala', districts: [{ name: 'Alappuzha', talukas: [{ name: 'Alappuzha', villages: ['Cherthala', 'Kayamkulam'] }] }, { name: 'Ernakulam', talukas: [{ name: 'Kochi', villages: ['Paravur', 'Aluva'] }] }, { name: 'Idukki', talukas: [{ name: 'Painavu', villages: ['Thodupuzha', 'Devikulam'] }] }, { name: 'Kannur', talukas: [{ name: 'Kannur', villages: ['Thalassery', 'Taliparamba'] }] }, { name: 'Kasaragod', talukas: [{ name: 'Kasaragod', villages: ['Hosdurg', 'Manjeshwar'] }] }, { name: 'Kollam', talukas: [{ name: 'Kollam', villages: ['Karunagappally', 'Punalur'] }] }, { name: 'Kottayam', talukas: [{ name: 'Kottayam', villages: ['Changanassery', 'Pala'] }] }, { name: 'Kozhikode', talukas: [{ name: 'Kozhikode', villages: ['Vatakara', 'Thamarassery'] }] }, { name: 'Malappuram', talukas: [{ name: 'Malappuram', villages: ['Tirur', 'Perinthalmanna'] }] }, { name: 'Palakkad', talukas: [{ name: 'Palakkad', villages: ['Ottapalam', 'Alathur'] }] }, { name: 'Pathanamthitta', talukas: [{ name: 'Pathanamthitta', villages: ['Adoor', 'Thiruvalla'] }] }, { name: 'Thiruvananthapuram', talukas: [{ name: 'Thiruvananthapuram', villages: ['Neyyattinkara', 'Varkala'] }] }, { name: 'Thrissur', talukas: [{ name: 'Thrissur', villages: ['Chavakad', 'Kodungallur'] }] }, { name: 'Wayanad', talukas: [{ name: 'Kalpetta', villages: ['Sultan Bathery', 'Mananthavady'] }] }] },
    { name: 'Ladakh', districts: [{ name: 'Leh', talukas: [{ name: 'Leh', villages: ['Nubra', 'Khalsi'] }] }, { name: 'Kargil', talukas: [{ name: 'Kargil', villages: ['Drass', 'Zanskar'] }] }] },
    { name: 'Lakshadweep', districts: [{ name: 'Lakshadweep', talukas: [{ name: 'Kavaratti', villages: ['Agatti', 'Amini'] }] }] },
    { name: 'Madhya Pradesh', districts: [{ name: 'Agar Malwa', talukas: [{ name: 'Agar', villages: ['Susner', 'Nalkheda'] }] }, { name: 'Alirajpur', talukas: [{ name: 'Alirajpur', villages: ['Jobat', 'Bhavra'] }] }, { name: 'Anuppur', talukas: [{ name: 'Anuppur', villages: ['Kotma', 'Jaithari'] }] }, { name: 'Ashoknagar', talukas: [{ name: 'Ashoknagar', villages: ['Chanderi', 'Mungaoli'] }] }, { name: 'Balaghat', talukas: [{ name: 'Balaghat', villages: ['Waraseoni', 'Baihar'] }] }, { name: 'Barwani', talukas: [{ name: 'Barwani', villages: ['Sendhwa', 'Rajpur'] }] }, { name: 'Betul', talukas: [{ name: 'Betul', villages: ['Multai', 'Amla'] }] }, { name: 'Bhind', talukas: [{ name: 'Bhind', villages: ['Gohad', 'Lahar'] }] }, { name: 'Bhopal', talukas: [{ name: 'Bhopal', villages: ['Berasia', 'Huzur'] }] }, { name: 'Burhanpur', talukas: [{ name: 'Burhanpur', villages: ['Nepanagar', 'Khaknar'] }] }, { name: 'Chhatarpur', talukas: [{ name: 'Chhatarpur', villages: ['Nowgong', 'Rajnagar'] }] }, { name: 'Chhindwara', talukas: [{ name: 'Chhindwara', villages: ['Parasia', 'Pandhurna'] }] }, { name: 'Damoh', talukas: [{ name: 'Damoh', villages: ['Hatta', 'Patharia'] }] }, { name: 'Datia', talukas: [{ name: 'Datia', villages: ['Seondha', 'Bhander'] }] }, { name: 'Dewas', talukas: [{ name: 'Dewas', villages: ['Sonkatch', 'Kannod'] }] }, { name: 'Dhar', talukas: [{ name: 'Dhar', villages: ['Manawar', 'Kukshi'] }] }, { name: 'Dindori', talukas: [{ name: 'Dindori', villages: ['Shahpura', ''] }] }, { name: 'Guna', talukas: [{ name: 'Guna', villages: ['Raghogarh', 'Chachaura'] }] }, { name: 'Gwalior', talukas: [{ name: 'Gwalior', villages: ['Dabra', 'Bhitarwar'] }] }, { name: 'Harda', talukas: [{ name: 'Harda', villages: ['Timarni', 'Khirkiya'] }] }, { name: 'Hoshangabad', talukas: [{ name: 'Hoshangabad', villages: ['Itarsi', 'Seoni-Malwa'] }] }, { name: 'Indore', talukas: [{ name: 'Indore', villages: ['Mhow', 'Depalpur'] }] }, { name: 'Jabalpur', talukas: [{ name: 'Jabalpur', villages: ['Sihora', 'Patan'] }] }, { name: 'Jhabua', talukas: [{ name: 'Jhabua', villages: ['Thandla', 'Petlawad'] }] }, { name: 'Katni', talukas: [{ name: 'Katni', villages: ['Murwara', 'Vijayraghavgarh'] }] }, { name: 'Khandwa', talukas: [{ name: 'Khandwa', villages: ['Harsud', 'Pandhana'] }] }, { name: 'Khargone', talukas: [{ name: 'Khargone', villages: ['Kasrawad', 'Maheshwar'] }] }, { name: 'Mandla', talukas: [{ name: 'Mandla', villages: ['Nainpur', 'Bichhiya'] }] }, { name: 'Mandsaur', talukas: [{ name: 'Mandsaur', villages: ['Garoth', 'Bhanpura'] }] }, { name: 'Morena', talukas: [{ name: 'Morena', villages: ['Ambah', 'Sabalgarh'] }] }, { name: 'Narsinghpur', talukas: [{ name: 'Narsinghpur', villages: ['Gadarwara', 'Tendukheda'] }] }, { name: 'Neemuch', talukas: [{ name: 'Neemuch', villages: ['Jawad', 'Manasa'] }] }, { name: 'Panna', talukas: [{ name: 'Panna', villages: ['Ajaygarh', 'Gunnaor'] }] }, { name: 'Raisen', talukas: [{ name: 'Raisen', villages: ['Goharganj', 'Begamganj'] }] }, { name: 'Rajgarh', talukas: [{ name: 'Rajgarh', villages: ['Biaora', 'Narsinghgarh'] }] }, { name: 'Ratlam', talukas: [{ name: 'Ratlam', villages: ['Jaora', 'Alot'] }] }, { name: 'Rewa', talukas: [{ name: 'Rewa', villages: ['Sirmour', 'Teonthar'] }] }, { name: 'Sagar', talukas: [{ name: 'Sagar', villages: ['Khurai', 'Bina'] }] }, { name: 'Satna', talukas: [{ name: 'Satna', villages: ['Maihar', 'Amarpatan'] }] }, { name: 'Sehore', talukas: [{ name: 'Sehore', villages: ['Ashta', 'Ichhawar'] }] }, { name: 'Seoni', talukas: [{ name: 'Seoni', villages: ['Lakhnadon', 'Keolari'] }] }, { name: 'Shahdol', talukas: [{ name: 'Shahdol', villages: ['Beohari', 'Gohparu'] }] }, { name: 'Shajapur', talukas: [{ name: 'Shajapur', villages: ['Shujalpur', 'Kalapipal'] }] }, { name: 'Sheopur', talukas: [{ name: 'Sheopur', villages: ['Vijaypur', 'Karahal'] }] }, { name: 'Shivpuri', talukas: [{ name: 'Shivpuri', villages: ['Pohari', 'Kolaras'] }] }, { name: 'Sidhi', talukas: [{ name: 'Sidhi', villages: ['Churhat', 'Gopadbanas'] }] }, { name: 'Singrauli', talukas: [{ name: 'Singrauli', villages: ['Waidhan', 'Deosar'] }] }, { name: 'Tikamgarh', talukas: [{ name: 'Tikamgarh', villages: ['Jatara', 'Niwari'] }] }, { name: 'Ujjain', talukas: [{ name: 'Ujjain', villages: ['Nagda', 'Tarana'] }] }, { name: 'Umaria', talukas: [{ name: 'Umaria', villages: ['Bandhavgarh', 'Pali'] }] }, { name: 'Vidisha', talukas: [{ name: 'Vidisha', villages: ['Basoda', 'Sironj'] }] }] },
    {
      name: 'Maharashtra',
      districts: [
        { name: 'Ahmednagar', talukas: [{ name: 'Ahmednagar', villages: ['Pathardi', 'Karjat'] }] },
        { name: 'Akola', talukas: [{ name: 'Akola', villages: ['Akot', 'Murtijapur'] }] },
        { name: 'Amravati', talukas: [{ name: 'Amravati', villages: ['Warud', 'Achalpur'] }] },
        { name: 'Aurangabad', talukas: [{ name: 'Aurangabad', villages: ['Sillod', 'Paithan'] }] },
        { name: 'Beed', talukas: [{ name: 'Beed', villages: ['Parli', 'Ambajogai'] }] },
        { name: 'Bhandara', talukas: [{ name: 'Bhandara', villages: ['Tumsar', 'Sakoli'] }] },
        { name: 'Buldhana', talukas: [{ name: 'Buldhana', villages: ['Khamgaon', 'Malkapur'] }] },
        { name: 'Chandrapur', talukas: [{ name: 'Chandrapur', villages: ['Ballarpur', 'Warora'] }] },
        { name: 'Dhule', talukas: [{ name: 'Dhule', villages: ['Shirpur', 'Sakri'] }] },
        { name: 'Gadchiroli', talukas: [{ name: 'Gadchiroli', villages: ['Aheri', 'Desaiganj'] }] },
        { name: 'Gondia', talukas: [{ name: 'Gondia', villages: ['Tirora', 'Deori'] }] },
        { name: 'Hingoli', talukas: [{ name: 'Hingoli', villages: ['Kalamnuri', 'Sengaon'] }] },
        { name: 'Jalgaon', talukas: [{ name: 'Jalgaon', villages: ['Bhusawal', 'Chalisgaon'] }] },
        { name: 'Jalna', talukas: [{ name: 'Jalna', villages: ['Ambad', 'Bhokardan'] }] },
        { name: 'Kolhapur', talukas: [{ name: 'Kolhapur', villages: ['Ichalkaranji', 'Panhala'] }] },
        { name: 'Latur', talukas: [{ name: 'Latur', villages: ['Udgir', 'Ausa'] }] },
        {
          name: 'Mumbai City',
          talukas: [{ name: 'Mumbai', villages: ['Fort', 'Dadar'] }]
        },
        {
        ...
        { name: 'Nanded', talukas: [{ name: 'Nanded', villages: ['Deglur', 'Kinwat'] }] },
        { name: 'Nandurbar', talukas: [{ name: 'Nandurbar', villages: ['Shahada', 'Taloda'] }] },
        {
          name: 'Nashik',
          talukas: [
        ...
        { name: 'Osmanabad', talukas: [{ name: 'Osmanabad', villages: ['Tuljapur', 'Umarga'] }] },
        { name: 'Palghar', talukas: [{ name: 'Palghar', villages: ['Vasai', 'Dahanu'] }] },
        { name: 'Parbhani', talukas: [{ name: 'Parbhani', villages: ['Sailu', 'Gangakhed'] }] },
        {
          name: 'Pune',
          talukas: [
        ...
        { name: 'Raigad', talukas: [{ name: 'Alibag', villages: ['Panvel', 'Mahad'] }] },
        { name: 'Ratnagiri', talukas: [{ name: 'Ratnagiri', villages: ['Chiplun', 'Dapoli'] }] },
        { name: 'Sangli', talukas: [{ name: 'Sangli', villages: ['Miraj', 'Islampur'] }] },
        { name: 'Satara', talukas: [{ name: 'Satara', villages: ['Karad', 'Phaltan'] }] },
        { name: 'Sindhudurg', talukas: [{ name: 'Oros', villages: ['Kankavli', 'Sawantwadi'] }] },
        { name: 'Solapur', talukas: [{ name: 'Solapur', villages: ['Pandharpur', 'Barshi'] }] },
        { name: 'Thane', talukas: [{ name: 'Thane', villages: ['Kalyan', 'Ulhasnagar'] }] },
        { name: 'Wardha', talukas: [{ name: 'Wardha', villages: ['Hinganghat', 'Arvi'] }] },
        { name: 'Washim', talukas: [{ name: 'Washim', villages: ['Karanja', 'Mangrulpir'] }] },
        { name: 'Yavatmal', talukas: [{ name: 'Yavatmal', villages: ['Pusad', 'Wani'] }] },
      ]
    },
    { name: 'Manipur', districts: [{ name: 'Bishnupur', talukas: [{ name: 'Bishnupur', villages: ['Moirang', 'Nambol'] }] }, { name: 'Chandel', talukas: [{ name: 'Chandel', villages: ['Chakpikarong', 'Machi'] }] }, { name: 'Churachandpur', talukas: [{ name: 'Churachandpur', villages: ['Singngat', 'Tipaimukh'] }] }, { name: 'Imphal East', talukas: [{ name: 'Porompat', villages: ['Jiribam', 'Keirao Bitra'] }] }, { name: 'Imphal West', talukas: [{ name: 'Lamphelpat', villages: ['Wangoi', 'Patsoi'] }] }, { name: 'Senapati', talukas: [{ name: 'Senapati', villages: ['Mao-Maram', 'Paomata'] }] }, { name: 'Tamenglong', talukas: [{ name: 'Tamenglong', villages: ['Tamei', 'Tousem'] }] }, { name: 'Thoubal', talukas: [{ name: 'Thoubal', villages: ['Lilong', 'Kakching'] }] }, { name: 'Ukhrul', talukas: [{ name: 'Ukhrul', villages: ['Kamjong', 'Phungyar'] }] }] },
    { name: 'Meghalaya', districts: [{ name: 'East Garo Hills', talukas: [{ name: 'Williamnagar', villages: ['Samanda', 'Songsak'] }] }, { name: 'East Jaintia Hills', talukas: [{ name: 'Khliehriat', villages: ['Saipung', 'Sutnga'] }] }, { name: 'East Khasi Hills', talukas: [{ name: 'Shillong', villages: ['Sohra', 'Mawkynrew'] }] }, { name: 'North Garo Hills', talukas: [{ name: 'Resubelpara', villages: ['Bajengdoba', 'Kharkutta'] }] }, { name: 'Ri Bhoi', talukas: [{ name: 'Nongpoh', villages: ['Umling', 'Jirang'] }] }, { name: 'South Garo Hills', talukas: [{ name: 'Baghmara', villages: ['Chokpot', 'Gasuapara'] }] }, { name: 'South West Garo Hills', talukas: [{ name: 'Ampati', villages: ['Betasing', 'Zikzak'] }] }, { name: 'South West Khasi Hills', talukas: [{ name: 'Mawkyrwat', villages: ['Ranikor', ''] }] }, { name: 'West Garo Hills', talukas: [{ name: 'Tura', villages: ['Dadenggiri', 'Selsella'] }] }, { name: 'West Jaintia Hills', talukas: [{ name: 'Jowai', villages: ['Amlarem', 'Thadlaskein'] }] }, { name: 'West Khasi Hills', talukas: [{ name: 'Nongstoin', villages: ['Mairang', 'Mawshynrut'] }] }] },
    { name: 'Mizoram', districts: [{ name: 'Aizawl', talukas: [{ name: 'Aizawl', villages: ['Darlawn', 'Phullen'] }] }, { name: 'Champhai', talukas: [{ name: 'Champhai', villages: ['Khawbung', 'Ngopa'] }] }, { name: 'Kolasib', talukas: [{ name: 'Kolasib', villages: ['Vairengte', 'Bilkhawthlir'] }] }, { name: 'Lawngtlai', talukas: [{ name: 'Lawngtlai', villages: ['Chawngte', 'Saiha'] }] }, { name: 'Lunglei', talukas: [{ name: 'Lunglei', villages: ['Hnahthial', 'Tlabung'] }] }, { name: 'Mamit', talukas: [{ name: 'Mamit', villages: ['Zawlnuam', 'Reiek'] }] }, { name: 'Saiha', talukas: [{ name: 'Saiha', villages: ['Tuipang', 'Sangau'] }] }, { name: 'Serchhip', talukas: [{ name: 'Serchhip', villages: ['Thenzawl', 'N. Vanlaiphai'] }] }] },
    { name: 'Nagaland', districts: [{ name: 'Dimapur', talukas: [{ name: 'Dimapur', villages: ['Niuland', 'Chumukedima'] }] }, { name: 'Kiphire', talukas: [{ name: 'Kiphire', villages: ['Pungro', 'Kiusam'] }] }, { name: 'Kohima', talukas: [{ name: 'Kohima', villages: ['Tseminyu', 'Jakhama'] }] }, { name: 'Longleng', talukas: [{ name: 'Longleng', villages: ['Tamlu', 'Namsang'] }] }, { name: 'Mokokchung', talukas: [{ name: 'Mokokchung', villages: ['Tuli', 'Changtongya'] }] }, { name: 'Mon', talukas: [{ name: 'Mon', villages: ['Tobu', 'Naginimora'] }] }, { name: 'Peren', talukas: [{ name: 'Peren', villages: ['Tening', 'Jalukie'] }] }, { name: 'Phek', talukas: [{ name: 'Phek', villages: ['Chozuba', 'Meluri'] }] }, { name: 'Tuensang', talukas: [{ name: 'Tuensang', villages: ['Noklak', 'Shamator'] }] }, { name: 'Wokha', talukas: [{ name: 'Wokha', villages: ['Bhandari', 'Sanis'] }] }, { name: 'Zunheboto', talukas: [{ name: 'Zunheboto', villages: ['Aghunato', 'Satakha'] }] }] },
    { name: 'Odisha', districts: [{ name: 'Angul', talukas: [{ name: 'Angul', villages: ['Talcher', 'Pallahara'] }] }, { name: 'Balangir', talukas: [{ name: 'Balangir', villages: ['Titlagarh', 'Patnagarh'] }] }, { name: 'Balasore', talukas: [{ name: 'Balasore', villages: ['Soro', 'Jaleswar'] }] }, { name: 'Bargarh', talukas: [{ name: 'Bargarh', villages: ['Padmapur', 'Attabira'] }] }, { name: 'Bhadrak', talukas: [{ name: 'Bhadrak', villages: ['Basudevpur', 'Dhamnagar'] }] }, { name: 'Boudh', talukas: [{ name: 'Boudh', villages: ['Kantamal', 'Harbhanga'] }] }, { name: 'Cuttack', talukas: [{ name: 'Cuttack', villages: ['Banki', 'Athagarh'] }] }, { name: 'Deogarh', talukas: [{ name: 'Deogarh', villages: ['Riamal', 'Barkote'] }] }, { name: 'Dhenkanal', talukas: [{ name: 'Dhenkanal', villages: ['Kamakhyanagar', 'Hindol'] }] }, { name: 'Gajapati', talukas: [{ name: 'Paralakhemundi', villages: ['Mohana', 'R.Udayagiri'] }] }, { name: 'Ganjam', talukas: [{ name: 'Chhatrapur', villages: ['Brahmapur', 'Asika'] }] }, { name: 'Jagatsinghpur', talukas: [{ name: 'Jagatsinghpur', villages: ['Paradeep', 'Kujang'] }] }, { name: 'Jajpur', talukas: [{ name: 'Jajpur', villages: ['Byasanagar', 'Dharmasala'] }] }, { name: 'Jharsuguda', talukas: [{ name: 'Jharsuguda', villages: ['Brajarajnagar', 'Laikera'] }] }, { name: 'Kalahandi', talukas: [{ name: 'Bhawanipatna', villages: ['Kesinga', 'Dharmagarh'] }] }, { name: 'Kandhamal', talukas: [{ name: 'Phulbani', villages: ['Baliguda', 'G.Udayagiri'] }] }, { name: 'Kendrapara', talukas: [{ name: 'Kendrapara', villages: ['Pattamundai', 'Aul'] }] }, { name: 'Kendujhar', talukas: [{ name: 'Kendujhar', villages: ['Barbil', 'Anandapur'] }] }, { name: 'Khordha', talukas: [{ name: 'Bhubaneswar', villages: ['Jatani', 'Banapur'] }] }, { name: 'Koraput', talukas: [{ name: 'Koraput', villages: ['Jeypore', 'Sunabeda'] }] }, { name: 'Malkangiri', talukas: [{ name: 'Malkangiri', villages: ['Mathili', 'Kalimela'] }] }, { name: 'Mayurbhanj', talukas: [{ name: 'Baripada', villages: ['Rairangpur', 'Udala'] }] }, { name: 'Nabarangpur', talukas: [{ name: 'Nabarangpur', villages: ['Umerkote', 'Raighar'] }] }, { name: 'Nayagarh', talukas: [{ name: 'Nayagarh', villages: ['Odagaon', 'Ranpur'] }] }, { name: 'Nuapada', talukas: [{ name: 'Nuapada', villages: ['Khariar', 'Komna'] }] }, { name: 'Puri', talukas: [{ name: 'Puri', villages: ['Konark', 'Pipili'] }] }, { name: 'Rayagada', talukas: [{ name: 'Rayagada', villages: ['Gunupur', 'Bissam Cuttack'] }] }, { name: 'Sambalpur', talukas: [{ name: 'Sambalpur', villages: ['Kuchinda', 'Rengali'] }] }, { name: 'Subarnapur', talukas: [{ name: 'Sonepur', villages: ['Birmaharajpur', 'Tarbha'] }] }, { name: 'Sundargarh', talukas: [{ name: 'Sundargarh', villages: ['Rourkela', 'Rajgangpur'] }] }] },
    { name: 'Puducherry', districts: [{ name: 'Karaikal', talukas: [{ name: 'Karaikal', villages: ['Thirunallar', 'Nedungadu'] }] }, { name: 'Mahe', talukas: [{ name: 'Mahe', villages: ['Palloor', 'Pandakkal'] }] }, { name: 'Puducherry', talukas: [{ name: 'Puducherry', villages: ['Ozhukarai', 'Ariyankuppam'] }] }, { name: 'Yanam', talukas: [{ name: 'Yanam', villages: ['Dariyaltippa', 'Mettakur'] }] }] },
    { name: 'Punjab', districts: [{ name: 'Amritsar', talukas: [{ name: 'Amritsar', villages: ['Ajnala', 'Baba Bakala'] }] }, { name: 'Barnala', talukas: [{ name: 'Barnala', villages: ['Tapa', 'Bhadaur'] }] }, { name: 'Bathinda', talukas: [{ name: 'Bathinda', villages: ['Rampura Phul', 'Talwandi Sabo'] }] }, { name: 'Faridkot', talukas: [{ name: 'Faridkot', villages: ['Kotkapura', 'Jaitu'] }] }, { name: 'Fatehgarh Sahib', talukas: [{ name: 'Sirhind', villages: ['Bassi Pathana', 'Amloh'] }] }, { name: 'Fazilka', talukas: [{ name: 'Fazilka', villages: ['Abohar', 'Jalalabad'] }] }, { name: 'Ferozepur', talukas: [{ name: 'Ferozepur', villages: ['Zira', 'Guruharsahai'] }] }, { name: 'Gurdaspur', talukas: [{ name: 'Gurdaspur', villages: ['Batala', 'Dera Baba Nanak'] }] }, { name: 'Hoshiarpur', talukas: [{ name: 'Hoshiarpur', villages: ['Dasuya', 'Mukerian'] }] }, { name: 'Jalandhar', talukas: [{ name: 'Jalandhar', villages: ['Phillaur', 'Nakodar'] }] }, { name: 'Kapurthala', talukas: [{ name: 'Kapurthala', villages: ['Phagwara', 'Sultanpur Lodhi'] }] }, { name: 'Ludhiana', talukas: [{ name: 'Ludhiana', villages: ['Jagraon', 'Samrala'] }] }, { name: 'Mansa', talukas: [{ name: 'Mansa', villages: ['Budhlada', 'Sardulgarh'] }] }, { name: 'Moga', talukas: [{ name: 'Moga', villages: ['Bagha Purana', 'Nihal Singh Wala'] }] }, { name: 'Muktsar', talukas: [{ name: 'Sri Muktsar Sahib', villages: ['Malout', 'Gidderbaha'] }] }, { name: 'Pathankot', talukas: [{ name: 'Pathankot', villages: ['Dhar Kalan', ''] }] }, { name: 'Patiala', talukas: [{ name: 'Patiala', villages: ['Rajpura', 'Nabha'] }] }, { name: 'Rupnagar', talukas: [{ name: 'Rupnagar', villages: ['Anandpur Sahib', 'Nangal'] }] }, { name: 'Sangrur', talukas: [{ name: 'Sangrur', villages: ['Sunam', 'Malerkotla'] }] }, { name: 'SAS Nagar', talukas: [{ name: 'Mohali', villages: ['Dera Bassi', 'Kharar'] }] }, { name: 'SBS Nagar', talukas: [{ name: 'Nawanshahr', villages: ['Banga', 'Balachaur'] }] }, { name: 'Tarn Taran', talukas: [{ name: 'Tarn Taran', villages: ['Patti', 'Khadoor Sahib'] }] }] },
    { name: 'Rajasthan', districts: [{ name: 'Ajmer', talukas: [{ name: 'Ajmer', villages: ['Kishangarh', 'Beawar'] }] }, { name: 'Alwar', talukas: [{ name: 'Alwar', villages: ['Behror', 'Tijara'] }] }, { name: 'Banswara', talukas: [{ name: 'Banswara', villages: ['Kushalgarh', 'Ghatol'] }] }, { name: 'Baran', talukas: [{ name: 'Baran', villages: ['Anta', 'Chhabra'] }] }, { name: 'Barmer', talukas: [{ name: 'Barmer', villages: ['Balotra', 'Siwana'] }] }, { name: 'Bharatpur', talukas: [{ name: 'Bharatpur', villages: ['Bayana', 'Deeg'] }] }, { name: 'Bhilwara', talukas: [{ name: 'Bhilwara', villages: ['Shahpura', 'Mandalgarh'] }] }, { name: 'Bikaner', talukas: [{ name: 'Bikaner', villages: ['Nokha', 'Lunkaransar'] }] }, { name: 'Bundi', talukas: [{ name: 'Bundi', villages: ['Keshoraipatan', 'Hindoli'] }] }, { name: 'Chittorgarh', talukas: [{ name: 'Chittorgarh', villages: ['Nimbahera', 'Rawatbhata'] }] }, { name: 'Churu', talukas: [{ name: 'Churu', villages: ['Sardarshahar', 'Sujangarh'] }] }, { name: 'Dausa', talukas: [{ name: 'Dausa', villages: ['Bandikui', 'Lalsot'] }] }, { name: 'Dholpur', talukas: [{ name: 'Dholpur', villages: ['Bari', 'Rajakhera'] }] }, { name: 'Dungarpur', talukas: [{ name: 'Dungarpur', villages: ['Sagwara', 'Aspur'] }] }, { name: 'Hanumangarh', talukas: [{ name: 'Hanumangarh', villages: ['Nohar', 'Pilibanga'] }] }, { name: 'Jaipur', talukas: [{ name: 'Jaipur', villages: ['Sanganer', 'Amber'] }] }, { name: 'Jaisalmer', talukas: [{ name: 'Jaisalmer', villages: ['Pokaran', 'Fatehgarh'] }] }, { name: 'Jalore', talukas: [{ name: 'Jalore', villages: ['Bhinmal', 'Sanchore'] }] }, { name: 'Jhalawar', talukas: [{ name: 'Jhalawar', villages: ['Jhalrapatan', 'Aklera'] }] }, { name: 'Jhunjhunu', talukas: [{ name: 'Jhunjhunu', villages: ['Nawalgarh', 'Udaipurwati'] }] }, { name: 'Jodhpur', talukas: [{ name: 'Jodhpur', villages: ['Phalodi', 'Osian'] }] }, { name: 'Karauli', talukas: [{ name: 'Karauli', villages: ['Hindaun', 'Todabhim'] }] }, { name: 'Kota', talukas: [{ name: 'Kota', villages: ['Ramganj Mandi', 'Sangod'] }] }, { name: 'Nagaur', talukas: [{ name: 'Nagaur', villages: ['Merta', 'Didwana'] }] }, { name: 'Pali', talukas: [{ name: 'Pali', villages: ['Sojat', 'Bali'] }] }, { name: 'Pratapgarh', talukas: [{ name: 'Pratapgarh', villages: ['Chhoti Sadri', 'Arnod'] }] }, { name: 'Rajsamand', talukas: [{ name: 'Rajsamand', villages: ['Nathdwara', 'Kumbhalgarh'] }] }, { name: 'Sawai Madhopur', talukas: [{ name: 'Sawai Madhopur', villages: ['Gangapur City', 'Bamanwas'] }] }, { name: 'Sikar', talukas: [{ name: 'Sikar', villages: ['Fatehpur', 'Neem Ka Thana'] }] }, { name: 'Sirohi', talukas: [{ name: 'Sirohi', villages: ['Abu Road', 'Pindwara'] }] }, { name: 'Sri Ganganagar', talukas: [{ name: 'Sri Ganganagar', villages: ['Anupgarh', 'Raisinghnagar'] }] }, { name: 'Tonk', talukas: [{ name: 'Tonk', villages: ['Niwai', 'Malpura'] }] }, { name: 'Udaipur', talukas: [{ name: 'Udaipur', villages: ['Girwa', 'Salumbar'] }] }] },
    { name: 'Sikkim', districts: [{ name: 'East Sikkim', talukas: [{ name: 'Gangtok', villages: ['Pakyong', 'Rongli'] }] }, { name: 'North Sikkim', talukas: [{ name: 'Mangan', villages: ['Chungthang', 'Dzongu'] }] }, { name: 'South Sikkim', talukas: [{ name: 'Namchi', villages: ['Ravangla', 'Jorethang'] }] }, { name: 'West Sikkim', talukas: [{ name: 'Gyalshing', villages: ['Yuksom', 'Soreng'] }] }] },
    { name: 'Tamil Nadu', districts: [{ name: 'Ariyalur', talukas: [{ name: 'Ariyalur', villages: ['Jayankondam', 'Sendurai'] }] }, { name: 'Chennai', talukas: [{ name: 'Chennai', villages: ['Mylapore', 'Tondiarpet'] }] }, { name: 'Coimbatore', talukas: [{ name: 'Coimbatore', villages: ['Mettupalayam', 'Pollachi'] }] }, { name: 'Cuddalore', talukas: [{ name: 'Cuddalore', villages: ['Chidambaram', 'Neyveli'] }] }, { name: 'Dharmapuri', talukas: [{ name: 'Dharmapuri', villages: ['Harur', 'Palacode'] }] }, { name: 'Dindigul', talukas: [{ name: 'Dindigul', villages: ['Palani', 'Kodaikanal'] }] }, { name: 'Erode', talukas: [{ name: 'Erode', villages: ['Bhavani', 'Gobichettipalayam'] }] }, { name: 'Kallakurichi', talukas: [{ name: 'Kallakurichi', villages: ['Sankarapuram', 'Chinnasalem'] }] }, { name: 'Kanchipuram', talukas: [{ name: 'Kanchipuram', villages: ['Sriperumbudur', 'Uthiramerur'] }] }, { name: 'Kanyakumari', talukas: [{ name: 'Nagercoil', villages: ['Thuckalay', 'Padmanabhapuram'] }] }, { name: 'Karur', talukas: [{ name: 'Karur', villages: ['Kulithalai', 'Aravakurichi'] }] }, { name: 'Krishnagiri', talukas: [{ name: 'Krishnagiri', villages: ['Hosur', 'Denkanikottai'] }] }, { name: 'Madurai', talukas: [{ name: 'Madurai', villages: ['Thirumangalam', 'Usilampatti'] }] }, { name: 'Nagapattinam', talukas: [{ name: 'Nagapattinam', villages: ['Velankanni', 'Vedaranyam'] }] }, { name: 'Namakkal', talukas: [{ name: 'Namakkal', villages: ['Tiruchengode', 'Rasipuram'] }] }, { name: 'Nilgiris', talukas: [{ name: 'Ooty', villages: ['Coonoor', 'Kotagiri'] }] }, { name: 'Perambalur', talukas: [{ name: 'Perambalur', villages: ['Kunnam', 'Veppanthattai'] }] }, { name: 'Pudukkottai', talukas: [{ name: 'Pudukkottai', villages: ['Aranthangi', 'Alangudi'] }] }, { name: 'Ramanathapuram', talukas: [{ name: 'Ramanathapuram', villages: ['Rameswaram', 'Paramakudi'] }] }, { name: 'Salem', talukas: [{ name: 'Salem', villages: ['Mettur', 'Attur'] }] }, { name: 'Sivaganga', talukas: [{ name: 'Sivaganga', villages: ['Karaikudi', 'Devakottai'] }] }, { name: 'Tenkasi', talukas: [{ name: 'Tenkasi', villages: ['Sankarankovil', 'Kadayanallur'] }] }, { name: 'Thanjavur', talukas: [{ name: 'Thanjavur', villages: ['Kumbakonam', 'Pattukkottai'] }] }, { name: 'Theni', talukas: [{ name: 'Theni', villages: ['Bodinayakanur', 'Periyakulam'] }] }, { name: 'Thoothukudi', talukas: [{ name: 'Thoothukudi', villages: ['Tiruchendur', 'Kovilpatti'] }] }, { name: 'Tiruchirappalli', talukas: [{ name: 'Tiruchirappalli', villages: ['Srirangam', 'Lalgudi'] }] }, { name: 'Tirunelveli', talukas: [{ name: 'Tirunelveli', villages: ['Palayamkottai', 'Ambasamudram'] }] }, { name: 'Tirupathur', talukas: [{ name: 'Tirupathur', villages: ['Vaniyambadi', 'Ambur'] }] }, { name: 'Tiruppur', talukas: [{ name: 'Tiruppur', villages: ['Avinashi', 'Dharapuram'] }] }, { name: 'Tiruvallur', talukas: [{ name: 'Tiruvallur', villages: ['Avadi', 'Poonamallee'] }] }, { name: 'Tiruvannamalai', talukas: [{ name: 'Tiruvannamalai', villages: ['Arani', 'Polur'] }] }, { name: 'Tiruvarur', talukas: [{ name: 'Tiruvarur', villages: ['Mannargudi', 'Thiruthuraipoondi'] }] }, { name: 'Vellore', talukas: [{ name: 'Vellore', villages: ['Gudiyatham', 'Katpadi'] }] }, { name: 'Viluppuram', talukas: [{ name: 'Viluppuram', villages: ['Tindivanam', 'Gingee'] }] }, { name: 'Virudhunagar', talukas: [{ name: 'Virudhunagar', villages: ['Sivakasi', 'Aruppukkottai'] }] }] },
    { name: 'Telangana', districts: [{ name: 'Adilabad', talukas: [{ name: 'Adilabad', villages: ['Utnur', 'Ichoda'] }] }, { name: 'Bhadradri Kothagudem', talukas: [{ name: 'Kothagudem', villages: ['Bhadrachalam', 'Yellandu'] }] }, { name: 'Hyderabad', talukas: [{ name: 'Hyderabad', villages: ['Secunderabad', 'Charminar'] }] }, { name: 'Jagitial', talukas: [{ name: 'Jagitial', villages: ['Korutla', 'Metpally'] }] }, { name: 'Jangaon', talukas: [{ name: 'Jangaon', villages: ['Ghanpur', 'Palakurthi'] }] }, { name: 'Jayashankar Bhupalpally', talukas: [{ name: 'Bhupalpally', villages: ['Mogullapally', 'Chityal'] }] }, { name: 'Jogulamba Gadwal', talukas: [{ name: 'Gadwal', villages: ['Alampur', 'Ieeja'] }] }, { name: 'Kamareddy', talukas: [{ name: 'Kamareddy', villages: ['Yellareddy', 'Banswada'] }] }, { name: 'Karimnagar', talukas: [{ name: 'Karimnagar', villages: ['Huzurabad', 'Jammikunta'] }] }, { name: 'Khammam', talukas: [{ name: 'Khammam', villages: ['Madhira', 'Sathupalli'] }] }, { name: 'Komaram Bheem', talukas: [{ name: 'Asifabad', villages: ['Kagaznagar', 'Jainoor'] }] }, { name: 'Mahabubabad', talukas: [{ name: 'Mahabubabad', villages: ['Dornakal', 'Maripeda'] }] }, { name: 'Mahbubnagar', talukas: [{ name: 'Mahbubnagar', villages: ['Narayanpet', 'Jadcherla'] }] }, { name: 'Mancherial', talukas: [{ name: 'Mancherial', villages: ['Bellampalli', 'Mandamarri'] }] }, { name: 'Medak', talukas: [{ name: 'Medak', villages: ['Narsapur', 'Ramayampet'] }] }, { name: 'Medchal-Malkajgiri', talukas: [{ name: 'Medchal', villages: ['Malkajgiri', 'Quthbullapur'] }] }, { name: 'Nagarkurnool', talukas: [{ name: 'Nagarkurnool', villages: ['Achampet', 'Kalwakurthy'] }] }, { name: 'Nalgonda', talukas: [{ name: 'Nalgonda', villages: ['Miryalaguda', 'Devarakonda'] }] }, { name: 'Nirmal', talukas: [{ name: 'Nirmal', villages: ['Bhainsa', 'Khanapur'] }] }, { name: 'Nizamabad', talukas: [{ name: 'Nizamabad', villages: ['Bodhan', 'Armur'] }] }, { name: 'Peddapalli', talukas: [{ name: 'Peddapalli', villages: ['Ramagundam', 'Manthani'] }] }, { name: 'Rajanna Sircilla', talukas: [{ name: 'Sircilla', villages: ['Vemulawada', 'Yellareddypet'] }] }, { name: 'Ranga Reddy', talukas: [{ name: 'Shamshabad', villages: ['Ibrahimpatnam', 'Chevella'] }] }, { name: 'Sangareddy', talukas: [{ name: 'Sangareddy', villages: ['Patancheru', 'Zaheerabad'] }] }, { name: 'Siddipet', talukas: [{ name: 'Siddipet', villages: ['Gajwel', 'Husnabad'] }] }, { name: 'Suryapet', talukas: [{ name: 'Suryapet', villages: ['Kodad', 'Huzurnagar'] }] }, { name: 'Vikarabad', talukas: [{ name: 'Vikarabad', villages: ['Tandur', 'Pargi'] }] }, { name: 'Wanaparthy', talukas: [{ name: 'Wanaparthy', villages: ['Kothakota', 'Pebbair'] }] }, { name: 'Warangal Rural', talukas: [{ name: 'Warangal', villages: ['Narsampet', 'Parkal'] }] }, { name: 'Warangal Urban', talukas: [{ name: 'Warangal', villages: ['Hanamkonda', 'Kazipet'] }] }, { name: 'Yadadri Bhuvanagiri', talukas: [{ name: 'Bhuvanagiri', villages: ['Choutuppal', 'Alair'] }] }] },
    { name: 'Tripura', districts: [{ name: 'Dhalai', talukas: [{ name: 'Ambassa', villages: ['Kamalpur', 'Gandacharra'] }] }, { name: 'Gomati', talukas: [{ name: 'Udaipur', villages: ['Amarpur', 'Karbook'] }] }, { name: 'Khowai', talukas: [{ name: 'Khowai', villages: ['Teliamura', 'Padmabil'] }] }, { name: 'North Tripura', talukas: [{ name: 'Dharmanagar', villages: ['Kanchanpur', 'Panisagar'] }] }, { name: 'Sepahijala', talukas: [{ name: 'Bishramganj', villages: ['Bishalgarh', 'Sonamura'] }] }, { name: 'South Tripura', talukas: [{ name: 'Belonia', villages: ['Sabroom', 'Santirbazar'] }] }, { name: 'Unakoti', talukas: [{ name: 'Kailasahar', villages: ['Kumarghat', 'Pecharthal'] }] }, { name: 'West Tripura', talukas: [{ name: 'Agartala', villages: ['Jirania', 'Mohanpur'] }] }] },
    { name: 'Uttar Pradesh', districts: [{ name: 'Agra', talukas: [{ name: 'Agra', villages: ['Fatehabad', 'Bah'] }] }, { name: 'Aligarh', talukas: [{ name: 'Aligarh', villages: ['Khair', 'Atrauli'] }] }, { name: 'Allahabad', talukas: [{ name: 'Allahabad', villages: ['Soraon', 'Phulpur'] }] }, { name: 'Ambedkar Nagar', talukas: [{ name: 'Akbarpur', villages: ['Tanda', 'Jalalpur'] }] }, { name: 'Amethi', talukas: [{ name: 'Gauriganj', villages: ['Amethi', 'Musafirkhana'] }] }, { name: 'Amroha', talukas: [{ name: 'Amroha', villages: ['Dhanaura', 'Hasanpur'] }] }, { name: 'Auraiya', talukas: [{ name: 'Auraiya', villages: ['Bidhuna', 'Ajitmal'] }] }, { name: 'Azamgarh', talukas: [{ name: 'Azamgarh', villages: ['Sagri', 'Mehnagar'] }] }, { name: 'Baghpat', talukas: [{ name: 'Baghpat', villages: ['Baraut', 'Khekra'] }] }, { name: 'Bahraich', talukas: [{ name: 'Bahraich', villages: ['Nanpara', 'Kaiserganj'] }] }, { name: 'Ballia', talukas: [{ name: 'Ballia', villages: ['Rasra', 'Bansdih'] }] }, { name: 'Balrampur', talukas: [{ name: 'Balrampur', villages: ['Tulsipur', 'Utraula'] }] }, { name: 'Banda', talukas: [{ name: 'Banda', villages: ['Baberu', 'Atarra'] }] }, { name: 'Barabanki', talukas: [{ name: 'Barabanki', villages: ['Nawabganj', 'Fatehpur'] }] }, { name: 'Bareilly', talukas: [{ name: 'Bareilly', villages: ['Aonla', 'Faridpur'] }] }, { name: 'Basti', talukas: [{ name: 'Basti', villages: ['Harraiya', 'Bhanpur'] }] }, { name: 'Bhadohi', talukas: [{ name: 'Gyanpur', villages: ['Bhadohi', 'Aurai'] }] }, { name: 'Bijnor', talukas: [{ name: 'Bijnor', villages: ['Nagina', 'Dhampur'] }] }, { name: 'Budaun', talukas: [{ name: 'Budaun', villages: ['Bisauli', 'Sahaswan'] }] }, { name: 'Bulandshahr', talukas: [{ name: 'Bulandshahr', villages: ['Sikandrabad', 'Khurja'] }] }, { name: 'Chandauli', talukas: [{ name: 'Chandauli', villages: ['Sakaldiha', 'Mughalsarai'] }] }, { name: 'Chitrakoot', talukas: [{ name: 'Chitrakoot Dham', villages: ['Karwi', 'Mau'] }] }, { name: 'Deoria', talukas: [{ name: 'Deoria', villages: ['Salempur', 'Rudrapur'] }] }, { name: 'Etah', talukas: [{ name: 'Etah', villages: ['Aliganj', 'Jalesar'] }] }, { name: 'Etawah', talukas: [{ name: 'Etawah', villages: ['Bharthana', 'Jaswantnagar'] }] }, { name: 'Faizabad', talukas: [{ name: 'Faizabad', villages: ['Ayodhya', 'Bikapur'] }] }, { name: 'Farrukhabad', talukas: [{ name: 'Farrukhabad', villages: ['Kaimganj', 'Amritpur'] }] }, { name: 'Fatehpur', talukas: [{ name: 'Fatehpur', villages: ['Bindki', 'Khaga'] }] }, { name: 'Firozabad', talukas: [{ name: 'Firozabad', villages: ['Tundla', 'Shikohabad'] }] }, { name: 'Gautam Buddh Nagar', talukas: [{ name: 'Noida', villages: ['Dadri', 'Jewar'] }] }, { name: 'Ghaziabad', talukas: [{ name: 'Ghaziabad', villages: ['Modinagar', 'Loni'] }] }, { name: 'Ghazipur', talukas: [{ name: 'Ghazipur', villages: ['Zamania', 'Mohammadabad'] }] }, { name: 'Gonda', talukas: [{ name: 'Gonda', villages: ['Colonelganj', 'Mankapur'] }] }, { name: 'Gorakhpur', talukas: [{ name: 'Gorakhpur', villages: ['Chauri Chaura', 'Bansgaon'] }] }, { name: 'Hamirpur', talukas: [{ name: 'Hamirpur', villages: ['Maudaha', 'Rath'] }] }, { name: 'Hapur', talukas: [{ name: 'Hapur', villages: ['Garhmukteshwar', 'Dhaulana'] }] }, { name: 'Hardoi', talukas: [{ name: 'Hardoi', villages: ['Shahabad', 'Sawayajpur'] }] }, { name: 'Hathras', talukas: [{ name: 'Hathras', villages: ['Sikandra Rao', 'Sadabad'] }] }, { name: 'Jalaun', talukas: [{ name: 'Orai', villages: ['Konch', 'Kalpi'] }] }, { name: 'Jaunpur', talukas: [{ name: 'Jaunpur', villages: ['Shahganj', 'Machhlishahr'] }] }, { name: 'Jhansi', talukas: [{ name: 'Jhansi', villages: ['Mauranipur', 'Garautha'] }] }, { name: 'Kannauj', talukas: [{ name: 'Kannauj', villages: ['Chhibramau', 'Tirwa'] }] }, { name: 'Kanpur Dehat', talukas: [{ name: 'Akbarpur', villages: ['Rasulabad', 'Derapur'] }] }, { name: 'Kanpur Nagar', talukas: [{ name: 'Kanpur', villages: ['Bilhaur', 'Ghatampur'] }] }, { name: 'Kasganj', talukas: [{ name: 'Kasganj', villages: ['Patiyali', 'Sahawar'] }] }, { name: 'Kaushambi', talukas: [{ name: 'Manjhanpur', villages: ['Sirathu', 'Chail'] }] }, { name: 'Kheri', talukas: [{ name: 'Lakhimpur', villages: ['Nighasan', 'Gola Gokarannath'] }] }, { name: 'Kushinagar', talukas: [{ name: 'Padrauna', villages: ['Kasya', 'Hata'] }] }, { name: 'Lalitpur', talukas: [{ name: 'Lalitpur', villages: ['Mahroni', 'Talbehat'] }] }, { name: 'Lucknow', talukas: [{ name: 'Lucknow', villages: ['Mohanlalganj', 'Bakshi Ka Talab'] }] }, { name: 'Maharajganj', talukas: [{ name: 'Maharajganj', villages: ['Nautanwa', 'Pharenda'] }] }, { name: 'Mahoba', talukas: [{ name: 'Mahoba', villages: ['Charkhari', 'Kulpahar'] }] }, { name: 'Mainpuri', talukas: [{ name: 'Mainpuri', villages: ['Karhal', 'Bhongaon'] }] }, { name: 'Mathura', talukas: [{ name: 'Mathura', villages: ['Vrindavan', 'Chhata'] }] }, { name: 'Mau', talukas: [{ name: 'Mau', villages: ['Muhammadabad-Gohna', 'Ghosi'] }] }, { name: 'Meerut', talukas: [{ name: 'Meerut', villages: ['Sardhana', 'Mawana'] }] }, { name: 'Mirzapur', talukas: [{ name: 'Mirzapur', villages: ['Chunar', 'Lalganj'] }] }, { name: 'Moradabad', talukas: [{ name: 'Moradabad', villages: ['Thakurdwara', 'Bilari'] }] }, { name: 'Muzaffarnagar', talukas: [{ name: 'Muzaffarnagar', villages: ['Budhana', 'Khatauli'] }] }, { name: 'Pilibhit', talukas: [{ name: 'Pilibhit', villages: ['Puranpur', 'Bisalpur'] }] }, { name: 'Pratapgarh', talukas: [{ name: 'Pratapgarh', villages: ['Kunda', 'Patti'] }] }, { name: 'Raebareli', talukas: [{ name: 'Raebareli', villages: ['Lalganj', 'Salon'] }] }, { name: 'Rampur', talukas: [{ name: 'Rampur', villages: ['Swar', 'Milak'] }] }, { name: 'Saharanpur', talukas: [{ name: 'Saharanpur', villages: ['Deoband', 'Nakur'] }] }, { name: 'Sambhal', talukas: [{ name: 'Sambhal', villages: ['Chandausi', 'Gunnar'] }] }, { name: 'Sant Kabir Nagar', talukas: [{ name: 'Khalilabad', villages: ['Mehdawal', 'Dhanghata'] }] }, { name: 'Shahjahanpur', talukas: [{ name: 'Shahjahanpur', villages: ['Tilhar', 'Powayan'] }] }, { name: 'Shamli', talukas: [{ name: 'Shamli', villages: ['Kairana', 'Un'] }] }, { name: 'Shravasti', talukas: [{ name: 'Bhinga', villages: ['Ikauna', 'Jamunaha'] }] }, { name: 'Siddharthnagar', talukas: [{ name: 'Naugarh', villages: ['Bansi', 'Domariyaganj'] }] }, { name: 'Sitapur', talukas: [{ name: 'Sitapur', villages: ['Laharpur', 'Biswan'] }] }, { name: 'Sonbhadra', talukas: [{ name: 'Robertsganj', villages: ['Dudhi', 'Ghorawal'] }] }, { name: 'Sultanpur', talukas: [{ name: 'Sultanpur', villages: ['Kadipur', 'Lambhua'] }] }, { name: 'Unnao', talukas: [{ name: 'Unnao', villages: ['Safipur', 'Purwa'] }] }, { name: 'Varanasi', talukas: [{ name: 'Varanasi', villages: ['Pindra', 'Raja Talab'] }] }] },
    { name: 'Uttarakhand', districts: [{ name: 'Almora', talukas: [{ name: 'Almora', villages: ['Ranikhet', 'Bhikiyasain'] }] }, { name: 'Bageshwar', talukas: [{ name: 'Bageshwar', villages: ['Kapkot', 'Garur'] }] }, { name: 'Chamoli', talukas: [{ name: 'Gopeshwar', villages: ['Joshimath', 'Karnaprayag'] }] }, { name: 'Champawat', talukas: [{ name: 'Champawat', villages: ['Lohaghat', 'Pati'] }] }, { name: 'Dehradun', talukas: [{ name: 'Dehradun', villages: ['Rishikesh', 'Vikasnagar'] }] }, { name: 'Haridwar', talukas: [{ name: 'Haridwar', villages: ['Roorkee', 'Laksar'] }] }, { name: 'Nainital', talukas: [{ name: 'Nainital', villages: ['Haldwani', 'Ramnagar'] }] }, { name: 'Pauri Garhwal', talukas: [{ name: 'Pauri', villages: ['Kotdwar', 'Srinagar'] }] }, { name: 'Pithoragarh', talukas: [{ name: 'Pithoragarh', villages: ['Dharchula', 'Didihat'] }] }, { name: 'Rudraprayag', talukas: [{ name: 'Rudraprayag', villages: ['Ukhimath', 'Jakholi'] }] }, { name: 'Tehri Garhwal', talukas: [{ name: 'New Tehri', villages: ['Narendranagar', 'Devprayag'] }] }, { name: 'Udham Singh Nagar', talukas: [{ name: 'Rudrapur', villages: ['Kashipur', 'Khatima'] }] }, { name: 'Uttarkashi', talukas: [{ name: 'Uttarkashi', villages: ['Bhatwari', 'Purola'] }] }] },
    { name: 'West Bengal', districts: [{ name: 'Alipurduar', talukas: [{ name: 'Alipurduar', villages: ['Falakata', 'Madarihat'] }] }, { name: 'Bankura', talukas: [{ name: 'Bankura', villages: ['Bishnupur', 'Khatra'] }] }, { name: 'Birbhum', talukas: [{ name: 'Suri', villages: ['Bolpur', 'Rampurhat'] }] }, { name: 'Cooch Behar', talukas: [{ name: 'Cooch Behar', villages: ['Dinhata', 'Mathabhanga'] }] }, { name: 'Dakshin Dinajpur', talukas: [{ name: 'Balurghat', villages: ['Gangarampur', 'Hili'] }] }, { name: 'Darjeeling', talukas: [{ name: 'Darjeeling', villages: ['Siliguri', 'Kurseong'] }] }, { name: 'Hooghly', talukas: [{ name: 'Chinsurah', villages: ['Serampore', 'Arambagh'] }] }, { name: 'Howrah', talukas: [{ name: 'Howrah', villages: ['Uluberia', 'Amta'] }] }, { name: 'Jalpaiguri', talukas: [{ name: 'Jalpaiguri', villages: ['Malbazar', 'Dhupguri'] }] }, { name: 'Jhargram', talukas: [{ name: 'Jhargram', villages: ['Binpur', 'Gopiballavpur'] }] }, { name: 'Kalimpong', talukas: [{ name: 'Kalimpong', villages: ['Gorubathan', 'Lava'] }] }, { name: 'Kolkata', talukas: [{ name: 'Kolkata', villages: [''] }] }, { name: 'Malda', talukas: [{ name: 'English Bazar', villages: ['Chanchal', 'Kaliachak'] }] }, { name: 'Murshidabad', talukas: [{ name: 'Baharampur', villages: ['Kandi', 'Lalbagh'] }] }, { name: 'Nadia', talukas: [{ name: 'Krishnanagar', villages: ['Kalyani', 'Ranaghat'] }] }, { name: 'North 24 Parganas', talukas: [{ name: 'Barasat', villages: ['Bidhannagar', 'Barrackpore'] }] }, { name: 'Paschim Bardhaman', talukas: [{ name: 'Asansol', villages: ['Durgapur', 'Raniganj'] }] }, { name: 'Paschim Medinipur', talukas: [{ name: 'Midnapore', villages: ['Kharagpur', 'Ghatal'] }] }, { name: 'Purba Bardhaman', talukas: [{ name: 'Bardhaman', villages: ['Katwa', 'Kalna'] }] }, { name: 'Purba Medinipur', talukas: [{ name: 'Tamluk', villages: ['Haldia', 'Contai'] }] }, { name: 'Purulia', talukas: [{ name: 'Purulia', villages: ['Raghunathpur', 'Jhalda'] }] }, { name: 'South 24 Parganas', talukas: [{ name: 'Alipore', villages: ['Diamond Harbour', 'Canning'] }] }, { name: 'Uttar Dinajpur', talukas: [{ name: 'Raiganj', villages: ['Islampur', 'Kaliaganj'] }] }] }
];
