...
export default function JobSeekersPage() {
    ...
    const usersQuery = useMemoFirebase(() => {
        ...
        return query(collection(firestore, 'users'), where('role', '==', 'Job Seeker'));
    }, [firestore, isAdmin]);
    ...
    return (
        <AppLayout>
            <div className="flex flex-col gap-8">
                <div>
                    <h1 className="font-headline text-3xl font-bold">Job Seekers</h1>
                                ...
                                {areUsersLoading || isUserLoading || isRoleLoading ? (
                                    ...
                                    users.map((user) => (
                                        <TableRow key={user.id}>
                                            ...
                                            <TableCell>
                                                <Badge variant="secondary">{user.jobTitle || 'N/A'}</Badge>
                                            </TableCell>
