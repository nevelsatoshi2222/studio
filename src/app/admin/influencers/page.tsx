...
export default function InfluencerApplicationsPage() {
    ...
    const usersQuery = useMemoFirebase(() => {
        ...
        return query(collection(firestore, 'users'), where('role', '==', 'Influencer'));
    }, [firestore, isAdmin]);
    ...
    return (
        <AppLayout>
            <div className="flex flex-col gap-8">
                <div>
                    <h1 className="font-headline text-3xl font-bold">Influencer Applications</h1>
                    <p className="text-muted-foreground">
                        Review and manage applications for the Influencer program.
                    </p>
                </div>
                <Card>
                    <CardHeader>
                        <CardTitle>Influencer Applicants</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
