...
function PollCard({ poll, state }: { poll: Poll; state: string }) {
  ...
  // This check assumes the `useUser` hook is updated to fetch `state` from Firestore.
      ...
      <div className="flex flex-col gap-6">
        ...
        {isLoading && (
            <div className="flex flex-col items-center justify-center gap-4 p-8 rounded-lg border mt-6">
                ...
                <h1 className="font-headline text-2xl font-bold">Generating Polls for {state}</h1>
                <p className="text-muted-foreground">Please wait while our AI analyzes the top state-level issues...</p>
            </div>
        )}
